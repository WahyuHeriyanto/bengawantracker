...
public class Main extends javax.swing.JFrame {
    ...
    public static void loc() {
        Scanner scan;
        File file = new File("C:\\Users\\Solo\\Documents\\Arduino\\coba.txt");
        try {
    ...
    private void wp() throws FileNotFoundException, IOException{
        ...
        addWaypoint(new MyWaypoint("Test 001", event, new GeoPosition(-7.5610259,110.8590408)));
    ...
    private void init() {
        ...
        //loop
       // while (loopwp){
        //     addWaypoint(new MyWaypoint("Test 001", event, new GeoPosition(-7.559465, 110.857608)));
        //     if (loopwp = false){
        //         clearWaypoint();
        //     }
        // }
