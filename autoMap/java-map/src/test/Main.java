...
import SerialArduino.SerialArduino;
...
public class Main extends javax.swing.JFrame {
    ...
    public void updateCoordinate(GeoPosition coor)throws FileNotFoundException, IOException{
        clearWaypoint();
        MyWaypoint cwp = new MyWaypoint("Test 001", event, coor);
